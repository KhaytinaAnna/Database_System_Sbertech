...
Можно попробовать восстановить данные из журнала транзакций. Журнал содержит записи о всех изменениях, которые были сделаны в базе данных, и может быть использован для восстановления данных после сбоя.
